...
class EmbeddedE2ETests : EmbeddedE2ETestCase() {
    ...
    fun testIncorrectMagicCodeValidation() {
        ...
        device.wait(Until.hasObject(By.clazz("android.webkit.WebView")), 30_000)
        Thread.sleep(15_000)
        enterCodeInWebView("e2e-magic-code", "000000")
        Thread.sleep(1_000)
    ...
    fun testMagicCodeExpiration() {
        ...
        device.wait(Until.hasObject(By.clazz("android.webkit.WebView")), 30_000)
        Thread.sleep(15_000)
        val code = mock.getIssuedMagicCode("test@frontegg.com")
            ?: throw AssertionError("No magic code issued")
    ...
    fun testResendMagicCodeButton() {
        ...
        val code = mock.getIssuedMagicCode("test@frontegg.com")
            ?: throw AssertionError("No magic code after resend")
        enterCodeInWebView("e2e-magic-code", code)
        Thread.sleep(1_000)
        tapWebButtonIfPresent("Verify", timeoutMs = 30_000)
        waitForUserEmail("test@frontegg.com", timeoutMs = 120_000)
    ...
    fun testSignupWithSocialLogin() {
        ...
        Thread.sleep(8_000)
        tapWebButtonIfPresent("Continue with Google", timeoutMs = 60_000)
        Thread.sleep(15_000)
        dismissBrowserForegroundIfNeeded()
    ...
    fun testForgotPasswordFlow() {
        ...
        Thread.sleep(5_000)
        // Type email into reset form via UiAutomator
        try {
            val input = device.findObject(By.clazz("android.widget.EditText"))
            input?.click()
            Thread.sleep(300)
            input?.text = "test@frontegg.com"
        } catch (_: Throwable) {}
