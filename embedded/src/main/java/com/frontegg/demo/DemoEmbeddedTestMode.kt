...
object DemoEmbeddedTestMode {
    ...
    const val MAGIC_CODE_EMAIL = "test-magic-code@frontegg.com"
    const val MAGIC_LINK_EMAIL = "test-magic-link@frontegg.com"
    const val SMS_LOGIN_EMAIL = "test-sms@frontegg.com"
    const val USERNAME_LOGIN_EMAIL = "test-username@frontegg.com"
    const val MFA_AUTHENTICATOR_EMAIL = "test-mfa-authenticator@frontegg.com"
    const val MFA_SMS_EMAIL = "test-mfa-sms@frontegg.com"
    const val FORGOT_PASSWORD_EMAIL = "test-forgot@frontegg.com"
    const val LOCKED_ACCOUNT_EMAIL = "test-locked@frontegg.com"
    const val EXPIRED_PASSWORD_EMAIL = "test-pwexpired@frontegg.com"
    const val TOS_SIGNUP_EMAIL = "test-tos@frontegg.com"
    const val CUSTOM_LOGIN_BOX_EMAIL = "test-custom-box@frontegg.com"
    const val ACTIVATION_EMAIL = "test-activation@frontegg.com"
    const val INVITATION_EMAIL = "test-invitation@frontegg.com"
    const val UNLOCK_EMAIL = "test-unlock@frontegg.com"
